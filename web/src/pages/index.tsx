  ...
  return (
    <div className='max-w-[1124px] h-screen mx-auto grid grid-cols-2 gap-28 items-center'>
      <main>
        ...
        <Image src={logoImg} alt='Icon NLW Copa'/>
        ...
        <form className='mt-10 flex gap-2'>
          <input className='flex-1 px-6 py-4 rounded bg-gray-800 border-gray-600 text-sm' type='text' required placeholder='Qual o nome do seu bolão?' />
